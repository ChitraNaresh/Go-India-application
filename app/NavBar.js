...
export default function Home() {
  ...
  return (
      <nav className='w-full bg-white h-14 flex items-center space-x-6 pl-4 pr-2'>
        <div className='flex w-full sm:w-4/5'>
      <ul className='list-none flex  items-center w-full'>
        <li className='w-1/5'>
          <img src="https://goindiastocks.com/Content/assets/images/logewithname.png" alt="logo" className='h-10'/>
        </li>
        <li className='bg-zinc-300 ml-4 flex p-1 w-3/5 sm:w-3/5'>
          <input type="search" className='h-6 bg-zinc-300 w-full outline-none' placeholder='Enter'/>
          ...
          <img src="https://assets.ccbp.in/frontend/react-js/male-avatar-img.png" alt="user" className='h-8 w-10 sm:hidden'/>
      </div>
      <ul className='flex items-center w-1/5 space-x-3 hidden sm:contents ml-3'>
